  ...
  return (
    <>
      <Link href={`clothes/${clothing._id}`}>
        <div className="col-span-1 cursor-pointer border-[1.2px] border-slate-200 bg-slate-200 rounded-sm p-2 duration-100 transition-all  hover:scale-105 text-center text-sm">
